...
const TakeH = new skill([Gainlowprot]," ",1,"You perpare your self for the up coming attacks, take 2 less damage from attacks for 3 rounds. Example: use Take the Hit SP Cost: 1",false,false);
...
let rooms =[
  ...
  new room("Outer Wall",
    ...
    ["A long cobblestone hallway with iron cells lining the walls, most only filled with corpses and bones of those who were forgotten and left to their fate.</p><p>Forward leads to an old, sturdy iron door with Jailer's Office inscribed into its face. Back leads to the Dungeon main hallway.</p>"],),
